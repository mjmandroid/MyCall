...
public class CallRecordAdapter extends BaseQuickAdapter<CallRecordBean,BaseViewHolder> {
    ...
    protected void convert(BaseViewHolder helper, CallRecordBean item) {
        helper.setText(R.id.item_call_record_id,item.getGovernId()+"");
        helper.setText(R.id.item_call_record_patientRealPhone,item.getPatientPhone());
        helper.setText(R.id.item_call_record_patientVirtualPhone,item.getPatientPhone_show());
        helper.setText(R.id.item_call_record_attacheVirtualPhone,item.getAttachePhone_show());
        helper.setText(R.id.item_call_record_projectName,item.getItemName());
