package com.it.fan.mycall.gloable;
...
public class GloableConstant {
    public static final String ATTACHETRUE = "attacheTrue";//专员真实电话号
    public static final String ATTACHEVITRUAL = "attacheVitrual";//专员虚拟电话号
